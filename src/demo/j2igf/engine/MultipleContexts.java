...
public final class MultipleContexts {

    private static final String TYPE_FACE = "Calibri";

    /*
     * Private constructor for Utility class.
     */
    private MultipleContexts() {
    }
     ...
     */
    private static final class Context1 extends Context {
        private Context1(Engine engine) {
            ...
            Sprite label = new FontAtlas(TYPE_FACE, window.getHeight() / 10, true)
            ...
            Sprite subLabel = new FontAtlas(TYPE_FACE, window.getHeight() / 25, true)
